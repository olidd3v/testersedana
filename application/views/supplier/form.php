              ...
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="text" name="supplier_id" value="<?php echo !empty($supplier) ? $supplier['kd_supplier'] : '';?>" id="suplier_id" class="form-control" placeholder="Kode Supplier"/>
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="<?php echo !empty($supplier) ? $supplier['supplier_city'] : '';?>" name="supplier_city" placeholder="City" id="city" class="form-control"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="phone">No Telp</label>
                    <div class="col-sm-8">
                      <input type="number" value="<?php echo !empty($supplier) ? $supplier['supplier_phone'] : '';?>" name="supplier_phone" placeholder="Phone" id="phone" class="form-control"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="rekening_bank">Rekening Bank</label>
                    <div class="col-sm-8">
                      <input type="text" value="<?php echo !empty($supplier) ? $supplier['rekening_bank'] : '';?>" name="rekening_bank" placeholder="Rekening Bank" id="rekening_bank" class="form-control"/>
                    </div>
                  </div>
                </div>
              </div>
