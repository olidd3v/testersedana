        ...
        if(product_id !== null && sale_price !== null){
            $.ajax({
                ...
                success: function(data){
                    ...
                    $("#total-pembelian-hidden").text(res.total_price);
        ...
        $.get($("base").attr("url") + 'transaksi/delete_item/'+rowid,
            function(data,status){
                if(status == 'success'  && data != 'false'){
                    ...
                    $("#total-pembelian-hidden").text(data);
                    $el.faLoading(false);
                }                
            }
        );
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(response.status == "ok"){
                        ...
                        // window.location.href = $("base").attr("url") + 'transaksi?page';
    ...
    $(".retur_penjualan_qty").on("keyup change",function(e){
        ...
        $.post(
            ...
            function(data,status){
                ...
                $("#total-pembelian-hidden").text(total);
            }
        );
    });
