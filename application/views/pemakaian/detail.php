            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="active"><a href="<?php echo site_url('pemakaian');?>">List Pemakaian</a></li>
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right">
                                <span><a href="<?php echo site_url('pemakaian');?>" class="btn btn-sm btn-default">Back</a></span>
