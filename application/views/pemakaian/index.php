      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="<?php echo site_url('pemakaian?page');?>">List Pemakaian</a></li>
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php echo site_url('pemakaian?search=true');?>" method="GET">
                <input type="hidden" class="form-control" name="search" value="true"/>
                <div class="box-body pad">
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="id">Kode Pemakaian</label>
                ...
                <?php if(isset($penjualans) && is_array($penjualans)){ ?>
                  <?php foreach($penjualans as $penjualan){?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('pemakaian/detail').'/'.$penjualan->id;?>" class="btn btn-xs btn-default">Detail</a>
                        <!-- <a href="<?php echo site_url('pemakaian/print_now').'/'.$penjualan->id;?>" class="btn btn-xs btn-primary btnPrint">Print</a> -->
                        <a onclick="return confirm('Are you sure you want to delete this pemakaian?');" href="<?php echo site_url('pemakaian/delete').'/'.$penjualan->id;?>" class="btn btn-xs btn-danger">Delete</a>
                      </td>
                    </tr>
                  <?php } ?>
                  <?php } ?>
