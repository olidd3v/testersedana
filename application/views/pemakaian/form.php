      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('pemakaian/create');?>">Input Pemakaian</a></li>
            <li role="presentation"><a href="<?php echo site_url('pemakaian?page');?>">List Pemakaian</a></li>
            <li role="presentation"><a href="<?php echo site_url('pemakaian/report');?>">Report Pemakaian</a></li>
          </ul>
		  <div class="box box-info">
            ...
            <form id="transaction-form" class="form-horizontal" method="POST" action="<?php echo site_url('pemakaian/update').'/'.$penjualan[0]->id;?>">
            <?php }else{?>
            <form id="transaction-form" class="form-horizontal" method="POST" action="<?php echo site_url('pemakaian/add_process');?>">
            <?php } ?>
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="kode">Kode Pemakaian</label>
                    <div class="col-sm-8">
              ...
              <div class="box-footer">
                <div class="col-md-3 col-md-offset-4">
                  <a class="btn btn-default" href="<?php echo site_url('pemakaian?page');?>">Cancel</a>
